      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-zinc-500">
            Purpose-built tools that streamline every part of your fire safety
            compliance workflow.
          </p>
        </div>
...
function FeatureCard({ icon: Icon, title, description }: Feature) {
  return (
    <div className="group rounded-xl border border-zinc-200 bg-white p-6 transition-all duration-200 hover:shadow-lg">
      <div className="mb-4 flex size-12 items-center justify-center rounded-full bg-red-50 text-red-600 transition-colors duration-200 group-hover:bg-red-100">
